...
MIRROR="http://mc.hostinpl.ru/f_PUjdUAtIdNhJDUY/hpl56/2i0JD2I2"
PMA_VERSION="5.1.3"
PANEL_NAME="panel_08_03_2022.zip"
...
install_panel()
{
	...
	wget --no-check-certificate $MIRROR/p/config_pma.txt -O /usr/share/phpmyadmin/config.inc.php 
	...
	wget --no-check-certificate $MIRROR/p/config_apache.txt -O /etc/apache2/sites-available/hostinpl.conf
	...
	a2enmod rewrite
	wget --no-check-certificate $MIRROR/p/php.ini -O /etc/php/7.4/apache2/php.ini
	wget --no-check-certificate $MIRROR/p/php.ini -O /etc/php/7.4/cli/php.ini
	...
	wget --no-check-certificate $MIRROR/p/$PANEL_NAME
...
install_location()
{
	...
	service nginx stop
	wget --no-check-certificate $MIRROR/l/php.ini -O /etc/php/7.4/fpm/php.ini
	wget --no-check-certificate $MIRROR/l/php.ini -O /etc/php/7.4/cli/php.ini
	wget --no-check-certificate $MIRROR/l/config_nginx.txt -O /etc/nginx/nginx.conf
	ln -snf /usr/share/zoneinfo/Europe/Moscow /etc/localtime && echo Europe/Moscow > /etc/timezone
	...
	wget --no-check-certificate $MIRROR/l/Dockerfile
...
dop_games()
{
	...
	case $case in
		1) 
			clear
			wget --no-check-certificate $MIRROR/l/g/samp.zip
		...
		2) 
			clear
			wget --no-check-certificate $MIRROR/l/g/crmp.zip
		...
		3) 
			clear
			wget --no-check-certificate $MIRROR/l/g/crmp037.zip
		...
		4) 
			clear
			wget --no-check-certificate $MIRROR/l/g/unit.zip
		...
		5) 
			clear
			wget --no-check-certificate $MIRROR/l/g/mta.zip
		...
		6) 
			clear
			wget --no-check-certificate $MIRROR/l/g/mine_and_mcpe.zip
		...
		7) 
			clear
			wget --no-check-certificate $MIRROR/l/g/cs.zip
		...
		8) 
			clear
			wget --no-check-certificate $MIRROR/l/g/css.zip
		...
		9) 
			clear
			wget --no-check-certificate $MIRROR/l/g/csgo.zip
		...
		10) 
			clear 
			wget --no-check-certificate $MIRROR/l/g/ragemp.zip
